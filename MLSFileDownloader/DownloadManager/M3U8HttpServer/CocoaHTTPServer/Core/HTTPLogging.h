...
#define HTTPLogError(frmt, ...)         NSLog((@"%s [Line %d] " frmt), __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__)

#define HTTPLogWarn(frmt, ...)          NSLog((@"%s [Line %d] " frmt), __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__)

#define HTTPLogInfo(frmt, ...)          NSLog((@"%s [Line %d] " frmt), __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__)

#define HTTPLogVerbose(frmt, ...)       NSLog((@"%s [Line %d] " frmt), __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__)

#define HTTPLogTrace()                  NSLog(@"%s [Line %d] ", __PRETTY_FUNCTION__, __LINE__)

#define HTTPLogTrace2(frmt, ...)        NSLog((@"%s [Line %d] " frmt), __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__)


#define HTTPLogCError(frmt, ...)       NSLog((@"%s [Line %d] " frmt), __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__)

#define HTTPLogCWarn(frmt, ...)        NSLog((@"%s [Line %d] " frmt), __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__)

#define HTTPLogCInfo(frmt, ...)        NSLog((@"%s [Line %d] " frmt), __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__)

#define HTTPLogCVerbose(frmt, ...)     NSLog((@"%s [Line %d] " frmt), __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__)

#define HTTPLogCTrace()                NSLog(@"%s [Line %d] ", __PRETTY_FUNCTION__, __LINE__)
